    ...
    <section className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        >
          ...
          {/* Email Input */}
          <motion.div variants={fadeUp} className="max-w-xl w-full px-4 space-y-4 mb-8">
            ...
            <p className="text-white/30 text-xs sm:text-sm leading-relaxed px-4">
              Stay updated with the latest releases and AI agent capabilities.
              Join the waitlist and get early access to TaskForge AI.
            </p>
          </motion.div>
